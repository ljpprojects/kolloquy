use std::sync::Arc;
use crate::{PASS2_PEPPER_SIZE, PASS2_THYME_SIZE, State};
...
pub fn compute_stage_2_digest(digest_1: [u8; PASS1_DIGEST_SIZE], salt_2: [u8; PASS2_SALT_SIZE], state: Arc<State>) -> PasswordHash {
    ...
    full_secret.copy_from_slice(state.thyme.expose_secret());
